"use client"
import { MdDashboard, MdDashboardCustomize ,MdManageAccounts } from "react-icons/md";
...
const Sidebar = () => {
  ...
  return (
    <div className="bg-white w-[300px] min-h-screen py-4 shrink-0">
      ...
      <ul className="space-y-4 mt-6">
        {menus.map(menu => <Link key={menu.title} href={menu.href} className={`flex gap-2 items-center p-4 rounded-lg cursor-pointer
         hover:bg-pink hover:text-white ${pathName === menu.href ? "bg-pink text-white": "bg-gray-200"}`}>
